...
os.environ["CUDA_VISIBLE_DEVICES"] = "{}".format(config['nni_pruning']['gpu'])
...
save_interface(path_to_interface = config['model']['path_to_interface'], interface=interface, name_component=component, params=params, summary=summary)