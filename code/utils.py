...
""",
"""Если точность обрезанных копий сети превышает 
точность следующих в очереди копий по данным 
с прошлых итераций, то прунинг не выполняется. 
Однако, если этот параметр превышает количество 
уже обрезанных копий, то прунинг будет 
выполнен на них.
""",
"""Лист из Name_sloi,
