    ...
    def __init__(self):
        ...
        self.convs = nn.ModuleList(
            [
                ...
                nn.Sequential(
                    nn.Conv2d(
                        512, 256, kernel_size=3, padding=12, dilation=12, bias=False
                    ),
                    nn.BatchNorm2d(256),
                    nn.ReLU(),
                ),
                nn.Sequential(
                    nn.Conv2d(
                        512, 256, kernel_size=3, padding=24, dilation=24, bias=False
                    ),
                    nn.BatchNorm2d(256),
                    nn.ReLU(),
                ),
                nn.Sequential(
                    nn.Conv2d(
                        512, 256, kernel_size=3, padding=36, dilation=36, bias=False
                    ),
                    nn.BatchNorm2d(256),
                    nn.ReLU(),
                ),
